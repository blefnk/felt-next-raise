...
- **🚀 Live Demo**: [felt-next-raise.vercel.app](https://felt-next-raise.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/felt-next-raise)
...
1. `git clone https://github.com/blefnk/felt-next-raise.git`
2. `cd felt-next-raise`
3. `bun i`
